...
export function HomePage({ locale, rootMode = false }: HomePageProps) {
  ...
  const sectionFrameClassName = 'mx-auto w-full max-w-7xl px-5 md:px-8';

  return (
    <>
      <section className="relative isolate">
        <div className={`${sectionFrameClassName} grid gap-8 pb-16 pt-10 md:grid-cols-[1.05fr_0.95fr] md:gap-10 md:pb-24 md:pt-20`}>
      ...
      <section className="border-y border-line bg-cloud/86 py-14 backdrop-blur dark:border-white/10 dark:bg-white/[0.03] md:py-16">
        <div className={`${sectionFrameClassName} grid gap-6 md:grid-cols-2 xl:grid-cols-4`}>
      ...
      <section className="bg-[#e0f2fe] py-20 dark:bg-[#082f49]">
        <div className={sectionFrameClassName}>
          <SectionHeading
      ...
      <section className="relative hidden overflow-hidden bg-[#fff4df] py-20 dark:bg-[#10202a] md:block">
