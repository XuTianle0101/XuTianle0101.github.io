...
| NVIDIA GPU 体系 | Cambricon MLU 体系 | 作用 |
| --- | --- | --- |
| CUDA | CNRT / MLU runtime | 设备运行时 |
| NCCL | CNCL | 多卡 collective 通信 |
| CUDA kernel | BANG / MLU kernel | 设备算子 |
| NVLink / PCIe / IB | MLU Link / PCIe / 网络 | 物理互联 |
| `backend="nccl"` | MLU 对应 backend / CNCL | 分布式后端 |
